...
public class SAParticleSystemType extends SAFXType{
	...
	public static IVelocityType VEL_NONE = new IVelocityType(){
		@Override
		public Vec3d getVelocity(SAParticleSystem sys, float... params) {
...
//				}
	...
	public static IVolumeType VOL_POINT = new IVolumeType() {
		...
		@Override
		public Vec3d getPosition(SAParticleSystem sys, DirResult dir, int i, int count) {
			return new Vec3d(0,0,0);
		}
	...
	@Override
	public List<SAParticleSystem> createParticleSystems(World world, double posX, double posY, double posZ,
			double motionX, double motionY, double motionZ) {
		ArrayList<SAParticleSystem> list = new ArrayList<SAParticleSystem>();
		list.add(new SAParticleSystem(world, this, posX, posY, posZ, motionX, motionY, motionZ));
		return list;
	}
	...
	public List<SAParticleSystem> createParticleSystemsOnEntity(Entity ent) {
		ArrayList<SAParticleSystem> list = new ArrayList<SAParticleSystem>();
		list.add(new SAParticleSystem(ent,this));
		return list;
	}
	...
	public List<SAParticleSystem> createParticleSystemsOnEntityItemAttached(Entity ent, EnumHand hand) {
		ArrayList<SAParticleSystem> list = new ArrayList<>();
		list.add(new SAParticleSystemItemAttached(ent, hand, this));
		return list;
	}*/
