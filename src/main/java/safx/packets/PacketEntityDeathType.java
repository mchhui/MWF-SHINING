...
//			System.out.println("Get Packet!");
			...
			/*if (SAConfig.cl_enableDeathFX){
			
				EntityPlayer ply = SAPackets.getPlayerFromContext(ctx);
				...
				if (deathtype!=DeathType.GORE || (deathtype==DeathType.GORE && SAConfig.cl_enableDeathFX_Gore)){
