...
public class RenderedGltfModelGL20MWF extends RenderedGltfModelGL20 implements IRenderedGltfModelMWF {
    ...
    public RenderedGltfModelGL20MWF(List<Runnable> gltfRenderData, GltfModel gltfModel) {
