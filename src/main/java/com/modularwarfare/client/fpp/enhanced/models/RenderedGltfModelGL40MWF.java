...
public class RenderedGltfModelGL40MWF extends RenderedGltfModelGL40 implements IRenderedGltfModelMWF {
    ...
    public RenderedGltfModelGL40MWF(List<Runnable> gltfRenderData, GltfModel gltfModel) {
