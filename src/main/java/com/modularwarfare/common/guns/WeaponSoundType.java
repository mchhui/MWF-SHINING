...
public enum WeaponSoundType {
    ...
    @SerializedName("weaponTakedown") Takedown("weaponTakedown", 12, null),
    
    @SerializedName("weaponTakedownEmpty") TakedownEmpty("weaponTakedownEmpty", 12, null),
    ...
    // 手雷音效
    @SerializedName("grenadeDraw") GrenadeDraw("grenadeDraw", 8, "grenade_arm"),
    @SerializedName("grenadeIdle") GrenadeIdle("grenadeIdle", 8, null),
