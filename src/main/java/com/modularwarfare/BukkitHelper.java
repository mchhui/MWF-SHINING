...
//        scriptEngine.put("event", event);
//        try {
//            scriptEngine.eval("       var bukkitEvent=new BukkitWeaponAttachmentEvent(toBukkitEntity(event.player),false,false,null,toBukkitItemstack(event.gun),toBukkitItemstack(event.attach));\r\n"
//                + "       Bukkit.getPluginManager().callEvent(bukkitEvent);\r\n"
...
//        scriptEngine.put("event", event);
//        try {
//            scriptEngine.eval("var bukkitEvent=new BukkitWeaponAttachmentEvent(toBukkitEntity(event.player),true,event.unloadAll,event.type,toBukkitItemstack(event.gun),null);\r\n"
//                + "Bukkit.getPluginManager().callEvent(bukkitEvent);\r\n"
//                + "if(bukkitEvent.isCanceled){\r\n"
//                + "    event.setCanceled(true);\r\n"
//                + "}");
...
//
//        public BukkitWeaponAttachmentEvent(EntityPlayer player, boolean isUnload, boolean isUnloadAll,
